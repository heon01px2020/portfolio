  ...
  return (
    <Layout>
      <div className="p-8 max-w-4xl">
        ...
        Computer Science and Mathematics. Originally from Seoul, Korea, 
        ...
        <p className="text-xl mb-4">
        My main interests lie in machine learning, operations research, 
        and mathematical analysis, but I am also interested in algebra, 
        probability, mathematical education, topology, quantitative finance, 
        game theory, and theoretical computer science.
        </p>
        <p className="text-xl mb-4">
        At Brown, I have been involved with the Outreach Committee under 
        the Undergraduate Student Council and will be introducing Brown 
        to incoming first-years as a Meiklejohn. I have also been a TA 
        for Graph Theory (MATH1230) and Fairness in Automated Decision 
        Making (CSCI1951z) and will be a TA for Design and Analysis of 
        Algorithms (CSCI1570) this fall (2024). I am also researching the 
        theoretical aspects of algorithms using iterated linear optimization 
